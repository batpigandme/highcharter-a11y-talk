...
### Feature: Screen-reader div

------------------------------------------------------------------------

### Feature: Sonification

* Highcharts JS version  
  - [Demo](https://www.highcharts.com/samples/nonav/highcharts/sonification/chart-earcon)

* Highcharts Sonification Studio (in collaboration with Georgia Institute of Technology)  
  - <https://sonification.highcharts.com/>


::: source
_n.b._ I didn't reproduce these.
:::
...
- Video: [Highsoft & Elsevier talk about Chart Accessibility at CSUN 2019](https://www.youtube.com/watch?v=kwCOxZ6JJ6I) (Interview with Øystein Moseng and Ted Gies)
